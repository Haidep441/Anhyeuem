...
ImageButton.Image = "http://www.roblox.com/asset/?id=86597697608178"
...
---------------SettingTab
Tabs.infor:AddSection("Nhóm Discord Của haidepzai~")
Tabs.infor:AddButton({
        Title = "Tham Gia Nhóm | HaiDepzai",
        Description = "https://discord.gg/hup| Sao Chép Link",
        Callback = function()
        setclipboard("https://discord.gg/hup| Sao Chép Link")
        end
    })
    Tabs.infor:AddSection("Kênh YouTube Của HaiDepZai~")
Tabs.infor:AddButton({
        Title = "Đăng Ký Kênh Của TVới Nha :>>",
        Description = "https://youtube.com/@sap co| Turbo Lite",
        Callback = function()
        setclipboard("YouTube: HaiDepZai")
        end
    })
---------------TabStatus
