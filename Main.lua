...
local v9_args = "banana Hub Update 1"
...
r113_113arg.hi:AddButton({
	Title = "Discord Server of banana  Hub",
...
r113_113arg.hi:AddButton({
	Title = "Discord Server of banana  Huby",
	Description = "https://discord.gg/P24sKJYapX",
	Callback = function()
		setclipboard("https://discord.gg/P24sKJYapX")
	end
	...
	["embeds"] = {
		{
			...
			["fields"] = {
				...
				{
					["name"] = "Thanks Used banana !",
					["value"] = "**banana  Hub | Free Script Update 1**",
					["inline"] = true
				}
			}
		}
